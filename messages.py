...
def get_welcome_messages():
    ...
    return [
        ...
        "בוא נתחיל במספר האישור שקיבלת 🔢/n זה בעצם מספר החשבונית שקיבלת, תחפש אותה במייל\n\n<B><U>מה מספר האישור שקיבלת? </U></B>\n\n(תכתוב אותו נקי - נטו ספרות - בלי תווים נוספים ✍️)" 
        "👋 <b>ברוך הבא לצ'אט!</b> זה הולך להיות מסע 🚀 <i>מרגש</i> במיוחד. <u>אתה לא לבד</u> – אני כאן לכל שאלה! 😊\n\n🔹 <b>שלב 1:</b> <i>ספר לי מי אתה</i> | 🔹 <b>שלב 2:</b> <u>שתף מה עובר עליך</u> | 🔹 <b>שלב 3:</b> קבל <b><i>מענה אישי</i></b> ✨\n\n<b>טיפ!</b> אל תשכח שאפשר לשלב <code>#קוד_מיוחד</code> בכל הודעה, וגם לבקש <a href='https://google.com'>עזרה כאן</a>. רוצה לראות עוד טריק? <u><i>תשלח לי סוד</i></u> 🤫\n\n<b><u>הכי חשוב:</u></b> <i>תכתוב בחופשיות, הכל אנונימי לגמרי ❤️</i> (אם נתקעת – פשוט כתוב <code>/help</code> ואני אגיע מיד!) 🧠"
