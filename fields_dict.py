...
FIELDS_DICT = {
    ...
    "usage_prompt_tokens_gpt_e": {"label": "טוקנים פרומט - GPT מחלץ משופר", "type": int},
    "usage_completion_tokens_gpt_e": {"label": "טוקנים תשובה - GPT מחלץ משופר", "type": int},
    "usage_total_tokens_gpt_e": {"label": "סך טוקנים - GPT מחלץ משופר", "type": int},
    "cached_tokens_gpt_e": {"label": "כמה מתוכם קשד", "type": int},
    "cost_gpt_e": {"label": "כמה עלה באגורות", "type": float},
    "model_gpt_e": {"label": "מודל GPT מחלץ משופר", "type": str},
