...
FIELDS_DICT = {
    ...
    "cost_gpt1": {"label": "כמה עלתה הקריאה באגורות", "type": int},
    ...
    "cost_gpt2": {"label": "כמה עלה באגורות", "type": int},
    ...
    "cost_gpt3": {"label": "כמה עלה באגורות", "type": int},
    ...
    "cost_GPT4": {"label": "כמה עלה באגורות", "type": int},
