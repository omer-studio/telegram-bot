...
FIELDS_DICT = {
    ...
    "pronoun_preference": {"label": "לשון פניה (את/אתה/מעורב)", "type": str, "show_in_summary": ""},
    "occupation_or_role": {"label": "עיסוק (מה עושה בחיים?)", "type": str, "show_in_summary": ""},
    "attracted_to": {"label": "משיכה לגברים/נשים/שניהם (ועוד אופציות)", "type": str, "show_in_summary": ""},
    ...
    "who_knows": {"label": "מי יודע עליו", "type": str, "show_in_summary": ""},
    "who_doesnt_know": {"label": "מי לא יודע עליו", "type": str, "show_in_summary": ""},
    "attends_therapy": {"label": "האם הולך לטיפול פסיכולוגי/רגשי/קבוצה כרגע?", "type": str, "show_in_summary": ""},
    "primary_conflict": {"label": "הסיפור / קונפליקט המרכזי שלו בחיים כרגע", "type": str, "show_in_summary": ""},
    "trauma_history": {"label": "טראומות אם ציין (להתנסח בזהירות ובעדינות ועם הרחבה)", "type": str, "show_in_summary": ""},
    "goal_in_course": {"label": "מה הוא רוצה שיקרה לו מהקורס (המטרות ששם לעצמו)", "type": str, "show_in_summary": ""},
    "language_of_strength": {"label": "משפטים מחזקים שהוא משתמש בהם (מה עוזר לו בזמנים קשים?)", "type": str, "show_in_summary": ""},
    "date_first_seen": {"label": "מתי התחילה השיחה איתו", "type": str, "show_in_summary": ""},
    "coping_strategies": {"label": "מה מרים אותך? מה עוזר לך להתמודד?", "type": str, "show_in_summary": ""},
    "fears_concerns": {"label": "פחדים וחששות", "type": str, "show_in_summary": ""},
    "future_vision": {"label": "מה החזון לעתיד", "type": str, "show_in_summary": ""},
