...
FIELDS_DICT = {
    ...
    "usage_prompt_tokens_GPT-A": {"label": "טוקנים פרומט - GPT ראשי", "type": int},
    "usage_completion_tokens_GPT-A": {"label": "טוקנים תשובה - GPT ראשי", "type": int},
    "usage_total_tokens_GPT-A": {"label": "סך טוקנים - GPT ראשי", "type": int},
    "cached_tokens_gpt_a": {"label": "כמה מתוכם זה קשד", "type": int},
    "cost_gpt_a": {"label": "כמה עלתה הקריאה באגורות", "type": float},
    "model_GPT-A": {"label": "מודל GPT ראשי", "type": str},
    "usage_prompt_tokens_GPT-B": {"label": "טוקנים פרומט - GPT מקצר", "type": int},
    "usage_completion_tokens_GPT-B": {"label": "טוקנים תשובה - GPT מקצר", "type": int},
    "usage_total_tokens_GPT-B": {"label": "סך טוקנים - GPT מקצר", "type": int},
    "cached_tokens_gpt_b": {"label": "כמה מתוכם קשד", "type": int},
    "cost_gpt_b": {"label": "כמה עלה באגורות", "type": float},
    "model_GPT-B": {"label": "מודל GPT מקצר", "type": str},
    "usage_prompt_tokens_GPT-C": {"label": "טוקנים פרומט - GPT מחלץ", "type": int},
    "usage_completion_tokens_GPT-C": {"label": "טוקנים תשובה - GPT מחלץ", "type": int},
    "usage_total_tokens_GPT-C": {"label": "סך טוקנים - GPT מחלץ", "type": int},
    "cached_tokens_gpt_c": {"label": "כמה מתוכם קשד", "type": int},
    "cost_gpt_c": {"label": "כמה עלה באגורות", "type": float},
    "model_GPT-C": {"label": "מודל GPT מחלץ", "type": str},
    "usage_prompt_tokens_GPT-D": {"label": "טוקנים פרומט - GPT מיזוג חכם ת.ז רגשית", "type": int},
    "usage_completion_tokens_GPT-D": {"label": "טוקנים תשובה - GPT מיזוג חכם ת.ז רגשית", "type": int},
    "usage_total_tokens_GPT-D": {"label": "סך טוקנים - GPT מיזוג חכם ת.ז רגשית", "type": int},
    "cached_tokens_GPT-D": {"label": "כמה מתוכם קשד", "type": int},
    "cost_GPT-D": {"label": "כמה עלה באגורות", "type": float},
    "model_GPT-D": {"label": "מודל GPT מיזוג חכם ת.ז רגשית", "type": str},
    "fields_updated_by_gpt_d": {"label": "איזה פריטים חדשים נשמרו מGPT-C או GPT-D", "type": str},
