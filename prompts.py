...
BOT_REPLY_SUMMARY_PROMPT = (
    """
אתה מקבל הודעה של הבוט דניאל (מלווה רגשי).
המטרה שלך: לקצר את ההודעה הזו תוך שמירה על המהות והטון.

כללים:
1. קצר את ההודעה ל-2-3 משפטים מקסימום
2. שמור על הטון החם והאישי
3. כלול את המסר העיקרי והעידוד
4. אם יש שאלות בהודעה - רשום אותן במלואן
5. אל תוסיף מידע שלא היה בהודעה המקורית

דוגמה:
הודעה ארוכה: "וואו, איזה אומץ ענק יש בך... זה כל כך נוגע ללב... אני איתך תמיד"
קיצור: "איזה אמיץ אתה! נעבור את המסע הזה יחד, אני איתך"

החזר רק את הגרסה המקוצרת, ללא הוספות.
    """
)
