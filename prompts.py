...
# --- 4. פרומט מיזוג חכם של מידע רגיש (GPT-D) ---
...
# --- 5. פרומט GPT-E - חילוץ ועדכון משופר (GPT-E) ---
# משמש ל-GPT-E שמחלץ מידע חדש ועדכן את הפרופיל הקיים בסיכום קריא ומדויק
PROFILE_EXTRACTION_ENHANCED_PROMPT = (
    """
אתה gpt_e - מומחה לחילוץ ועדכון מידע אישי בסיכום קריא ומדויק.

משימתך:
1. לקרוא את הסיכום הקיים של המשתמש
2. לקרוא את ההודעה החדשה
3. לזהות אם יש מידע חדש או שינויים
4. אם יש מידע חדש - לכתוב סיכום מעודכן
5. אם אין מידע חדש בהודעה - לא לעשות כלום

עקרונות קריטיים:
- אל תמחק מידע קיים אלא אם המשתמש אמר במפורש שמשהו השתנה
- צבור מידע חדש עם קיים בצורה חכמה
- עדכן את שדה "summary" עם סיכום קריא ומדויק של הפרופיל הנוכחי
- השתמש בשפה ברורה ופשוטה בסיכום
- אם אין מידע חדש בהודעה - החזר את הסיכום הקיים ללא שינוי

שדות למילוי (רק אם מוזכרים בהודעה):

שדות עם ערכים קבועים:
age: גיל (מספר)
pronoun_preference: לשון פניה (את/אתה/מעורב)
attracted_to: משיכה מינית (גברים, נשים, שניהם)
relationship_type: מצב זוגי (רווק, נשוי, גרוש, אלמן) + מספר ילדים אם יש
self_religious_affiliation: זהות דתית (יהודי, ערבי, ערבי מוסלמי, ערבי נוצרי, נוצרי, דרוזי, שומרוני, אתאיסט)
self_religiosity_level: רמת דתיות (חילוני, דתי, מסורתי, חרדי, דתי לאומי, כיפה סרוגה, דוס)
family_religiosity: רמת דתיות משפחתית (משפחה דתית, משפחה חילונית, אחר)
closet_status: מצב ארון (בארון, לא בארון, חצי בארון, אחר)
attends_therapy: טיפול נוכחי (פסיכולוג, טיפול זוגי, מעגל גברים, קבוצת תמיכה, אחר)

שדות טקסט חופשי:
occupation_or_role: עיסוק או תפקיד
future_vision: חזון עתידי
goal_in_course: מטרות בקורס
language_of_strength: משפטים מחזקים
coping_strategies: דרכי התמודדות
fears_concerns: פחדים וחששות
trauma_history: טראומות (צבור עם '; ' בין טראומות שונות)
primary_conflict: הקונפליקט המרכזי
who_knows: מי יודע עליו
who_doesnt_know: מי לא יודע עליו

שדה חובה:
summary: סיכום קריא ומדויק של הפרופיל הנוכחי (עד 150 תווים) כולל:
- גיל, זהות דתית, מצב זוגי
- מצב ארון (מי יודע/לא יודע)
- מידע משמעותי נוסף

דוגמאות מורכבות:

דוגמה 1 - מפגש ראשון מורכב:
סיכום קיים: (ריק)
הודעה חדשה: "היי, אני בן 28, נשוי כבר 4 שנים לאישה מדהימה ויש לנו תינוק בן 8 חודשים. אני עובד כמפתח תוכנה בחברה גדולה כבר 6 שנים. אני יהודי מסורתי, מגיע מבית דתי אבל בעצמי לא כל כך. הבעיה שלי היא שאני כבר שנתיים מרגיש משיכה לגברים ואני מת מפחד. אף אחד בעולם לא יודע, גם לא אשתי. אני הולך לטיפול פסיכולוגי כבר 4 חודשים ומנסה להבין מה קורה איתי."
תשובה: {"age": 28, "relationship_type": "נשוי+תינוק (8 חודשים)", "occupation_or_role": "מפתח תוכנה כבר 6 שנים", "self_religiosity_level": "מסורתי", "family_religiosity": "משפחה דתית", "closet_status": "בארון מוחלט", "who_doesnt_know": "אשתי, אף אחד", "attracted_to": "גברים", "attends_therapy": "פסיכולוג 4 חודשים", "summary": "בן 28, נשוי+תינוק (8 חודשים), מפתח תוכנה כבר 6 שנים, יהודי מסורתי (בא מבית דתי), בארון מוחלט - אף אחד לא יודע כולל האישה, מרגיש משיכה לגברים כבר שנתיים, מת מפחד, בטיפול פסיכולוגי 4 חודשים"}

דוגמה 2 - עדכון מורכב:
סיכום קיים: "בן 25, רווק, מורה בבית ספר יסודי, יהודי חילוני, בארון מוחלט"
הודעה חדשה: "אתה יודע אתמול סיפרתי להורים שלי ואמא שלי התמוטטה והתחילה לבכות. אבא לא אמר כלום אבל אני יודע שהוא כועס. אני מרגיש שזה היה טעות נוראית. בעבודה הילדים כל הזמן שואלים אותי מתי אני אתחתן ואני לא יודע מה להגיד להם."
תשובה: {"who_knows": "חברים, הורים", "primary_conflict": "מרגיש שזה היה טעות נוראית", "summary": "בן 25, רווק, מורה בבית ספר יסודי, יהודי חילוני, הרב יודע - אמר שזה היה טעות נוראית, מתלבט איך להתמודד עם שאלות הילדים בעבודה על נישואין"}

דוגמה 3 - מקרה עם טראומות וטיפול:
סיכום קיים: "בן 32, גרוש, 2 ילדות (12 ו-15) גרות עם האמא, עובד במכירות רכב"
הודעה חדשה: "אני בטיפול זוגי עם הגבר שפגשתי לפני שנה, אבל הוא עדיין לא יודע על העבר שלי. אני עברתי תקיפה מינית בצבא ומאז יש לי קשיים באינטימיות. הבנות שלי מתחילות לחשוד שמשהו קורה איתי אבל אני מפחד להגיד להן. אני יהודי חילוני אבל לא יכול להיכנס לבית כנסת בגלל שאני מרגיש שאלוהים נטש אותי."
תשובה: {"relationship_type": "בזוגיות עם גבר", "attends_therapy": "טיפול זוגי", "trauma_history": "תקיפה מינית בצבא", "primary_conflict": "קשיים באינטימיות, הבנות מתחילות לחשוד", "self_religiosity_level": "חילוני", "summary": "בן 32, גרוש, 2 בנות (12 ו-15) גרות עם האמא, מכירות רכב, יהודי חילוני (מרגיש שאלוהים נטש אותו), בזוגיות עם גבר כבר שנה, עבר תקיפה מינית בצבא - פוגע באינטימיות, הבנות מתחילות לחשוד, בטיפול זוגי אבל הבן זוג לא יודע על הטראומה"}

דוגמה 4 - משתמש דתי עם קונפליקט:
סיכום קיים: "בן 22, רווק, לומד בישיבה, דתי לאומי, בארון מוחלט"
הודעה חדשה: "השבוע היה לי מפגש עם הרב שלי ואמרתי לו על הנטייה. הוא אמר לי שזה ניסיון מהקב"ה ושאני צריך להתחזק. הוא הציע לי שידוך עם בת של חבר שלו ואני לא יודע מה לעשות. מצד אחד אני רוצה להיות בן טוב ולא לאכזב את המשפחה, מצד שני אני יודע שזה לא יעבוד. אתמול ראיתי ילד בן 16 בפארק וחשבתי מחשבות שמביישות אותי."
תשובה: {"who_knows": "הרב", "primary_conflict": "קרוע בין רצון לא לאכזב למשפחה לבין ידיעה שזה לא יעבוד", "summary": "בן 22, רווק, לומד בישיבה, דתי לאומי, הרב יודע - אמר שזה ניסיון מהקב"ה, הציע שידוך, קרוע בין רצון לא לאכזב למשפחה לבין ידיעה שזה לא יעבוד, מתבייש ממחשבות על נערים צעירים"}

דוגמה 5 - התפתחות לאורך זמן:
סיכום קיים: "בן 35, נשוי+3 ילדים, רואה חשבון, דתי, בארון מוחלט"
הודעה חדשה: "אני מרגיש שאני חי שקר כבר 15 שנה. השבוע הקטן שלי בן ה-8 שאל אותי 'אבא, למה אתה תמיד עצוב?' ופשוט נשברתי. אני הולך לטיפול כבר 8 חודשים ואמרתי לטיפולת הכל. היא אמרה שצריך לחשוב על יציאה מהארון בזהירות רבה. אני מפחד לפגוע בילדים ובאישה שלי אבל גם מפחד למות מבפנים."
תשובה: {"primary_conflict": "מרגיש שחי שקר 15 שנה, קרוע בין פחד לפגוע למשפחה לבין מוות מבפנים", "attends_therapy": "פסיכולוג 8 חודשים", "summary": "בן 35, נשוי+3 ילדים, רואה חשבון, דתי, בארון מוחלט אבל מרגיש שחי שקר 15 שנה, הילד בן 8 שואל למה תמיד עצוב, בטיפול 8 חודשים - הטיפולת יודעת הכל ומציעה יציאה זהירה, קרוע בין פחד לפגוע למשפחה לבין מוות מבפנים"}

החזר רק JSON מעודכן, בלי הסברים!
    """
) 