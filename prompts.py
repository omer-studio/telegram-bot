...
INPUT:
- current_summary: מחרוזת טקסט שמתארת את המשתמש לפי מה שכבר ידוע (יכול להיות ריק)
- user_message: הודעה חדשה מהמשתמש (עשויה להכיל מידע חדש)

GOAL:
- לעדכן את current_summary אם user_message מוסיפה מידע חדש או משנה משהו חשוב
- להחזיר מחרוזת אחת בלבד — הסיכום החדש, או מחרוזת ריקה "" אם אין שינוי

STRUCTURE OF THE SUMMARY:
חבר בין שלושת החלקים הבאים – בתוך משפט אחד ברור וטבעי:
1. פרטים יבשים (חובה): גיל, מצב זוגי + ילדים, זהות אתנית, רמת דתיות, מצב הארון כולל מי יודע, עיסוק  
2. קונפליקט מרכזי (חובה אם קיים): הדבר המרכזי שמעסיק אותו בחיים כרגע, בעיקר סביב הנטייה המינית או הזהות האישית  
3. תוספות עומק (אם יש מקום): טראומות, רגשות, משפטים אישיים, גבולות עם הסביבה, מה עוזר לו, חלומות, כינויים עצמיים, משפטים מחזקים, תחושות פיזיות חוזרות, התנסויות קונקרטיות

IMPORTANT:
- תמיד כלול את כל השדות מהחלק הראשון
- אם מופיע קונפליקט רגשי משמעותי – כלול אותו
- אם יש מקום, הוסף גם עד 2–3 תוספות עומק
- אם הסיכום החדש עובר 300 תווים – קצץ רק מהחלק השלישי (תוספות עומק)

STEP-BY-STEP LOGIC:

1. שמור את current_summary בזיכרון

2. קרא את user_message ונתח אם נאמר מידע חדש

3. בדוק האם user_message מוסיפה מידע חדש שלא קיים עדיין ב־current_summary.  
אם current_summary ריק, כל מידע שנאמר נחשב לחדש.  
אם נאמר רק פרט אחד – החזר אותו בלבד בפורמט תקני.

4. אם נאמר מידע חדש – עדכן את current_summary לפי המבנה שתואר למעלה

5. סדר את הסיכום כך:
   - התחל בפרטים יבשים
   - המשך עם הקונפליקט המרכזי
   - סיים בתוספות עומק אם יש

6. כתוב הכל במשפט אחד, בעברית טבעית ופשוטה  
שמור על טון אנושי, מדויק, לא ניתוחי ולא דרמטי

7. אם נוצר סיכום חדש – החזר אותו. אם עבר 300 תווים – קצר מהחלק השלישי בלבד

8. RETURN:
   - אם אין שינוי → החזר את המחרוזת הריקה: ""
   - אם יש סיכום חדש → החזר אותו כשורת טקסט אחת בלבד

---

הקטע הבא מכיל דוגמאות שממחישות את הסגנון, המבנה והלוגיקה של המשימה.  
השתמש בהן רק כדי להבין איך הסיכום אמור להיראות.  
בעת יצירת הסיכום בפועל, עבוד תמיד על פי current_summary ו־user_message שיופיעו בהמשך.
...
➡️ דוגמה 1:  
בן 38, גרוש+3, יהודי, דתי כיפה סרוגה, בארון חלקי (רק אבא יודע), מפיק בטלוויזיה, מתמודד עם פחד עמוק לחשוף את עצמו בפני אמא, חי 5 שנים מאז היציאה מול אבא בלי שיח, רוצה לקבל את עצמו

➡️ דוגמה 2:  
בן 27, רווק, ערבי מוסלמי, מסורתי, בארון (אף אחד לא יודע), סטודנט להנדסה, מרגיש לכוד בין הזהות האישית למצופה ממנו, שומר הכל בבטן וכותב לעצמו מכתבים

➡️ דוגמה 3:  
בן 25, נשוי+1, בא ממשפחה דתית, בארון חלקי (סיפר לחבר מהעבר), עובד חינוך, פוחד שיגלו עליו, נזכר בתחושת בושה מהתיכון כשכולם לעגו לו

➡️ דוגמה 4:  
בן 22, רווק, חילוני, נמשך לגברים, בארון (אף אחד לא יודע), סטודנט לפסיכולוגיה, חולם על חיים גלויים עם בן זוג, מחזיק את עצמו דרך טיפול קבוע ומשפטים מעצימים
...
➡️ דוגמה 1:  
current_summary = "בן 30, רווק, יהודי, מסורתי, בארון (רק חבר קרוב יודע), עובד הייטק"  
user_message = "השבוע סיפרתי גם לאחותי"  
→ return: {"summary": "בן 30, רווק, יהודי, מסורתי, בארון חלקי (חבר קרוב ואחותו יודעים), עובד הייטק"}

➡️ דוגמה 2:  
current_summary = "בן 25, נשוי+1, בא ממשפחה דתית, בארון מלא, עובד חינוך, פוחד שהאישה תגלה"  
