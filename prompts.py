...
IMPORTANT:
- לעולם אל תקצר או תדלג על השדות מהחלק הראשון
- אם מופיע קונפליקט רגשי משמעותי – הוא חייב להופיע
- תוספות עומק יש להוסיף רק אם יש מקום – עד 2–3 רעיונות
- אם הסיכום ארוך מ־300 תווים – קצר רק את החלק השלישי
...
3. אם אין שום מידע חדש → עבור לשלב 8

4. אם כן – עדכן את current_summary לפי המבנה שתואר למעלה
...
→ return: "בן 30, רווק, יהודי, מסורתי, בארון חלקי (חבר קרוב ואחותו יודעים), עובד הייטק"
...
→ return: "בן 25, נשוי+1, בא ממשפחה דתית, בארון חלקי (סיפר לחבר מהעבר), עובד חינוך, פוחד שהאישה תגלה"

➡️ דוגמה 3:  
current_summary = "בן 24, רווק, דתי לשעבר, בארון"  
user_message = "לפני חודש סיפרתי לאחותי"  
→ return: "בן 24, רווק, דתי לשעבר, בארון חלקי (אחותו יודעת)"

➡️ דוגמה 4:  
current_summary = "בן 22, רווק, חילוני, נמשך לגברים, בארון (אף אחד לא יודע)"  
user_message = "אני סטודנט לפסיכולוגיה"  
→ return: "בן 22, רווק, חילוני, נמשך לגברים, בארון (אף אחד לא יודע), סטודנט לפסיכולוגיה"

➡️ דוגמה 5:  
current_summary = "בן 31, גרוש+1, מסורתי, בארון חלקי, עובד בתחום הבנייה"  
user_message = "אני מזכיר לעצמי שיש בי חוזק פנימי"  
→ return: "בן 31, גרוש+1, מסורתי, בארון חלקי, עובד בתחום הבנייה, מזכיר לעצמו שיש בו חוזק פנימי"
    """
)
