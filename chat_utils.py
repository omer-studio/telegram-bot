...
def get_weekday_context_instruction(chat_id: str | None = None, user_msg: str | None = None) -> str:
    try:
        ...
        weekday_instructions = {
            1: "היום יום ראשון - תחילת שבוע. שאל אותו בפורמט הבא (כל שאלה בשורה נפרדת): 'היי! 👋\nאיך התחיל השבוע? 😊\nיש לך תוכניות מיוחדות השבוע? 🤔\nאיך אתה מרגיש עם תחילת שבוע חדש? 💪' התייחס באופן חיובי ועודד אותו לשבוע הקרב.",
            2: "היום יום שני.",
            3: "היום יום שלישי.",
            4: "היום יום רביעי.",
