...
async def lifespan(app: FastAPI):
    ...
    # 🏠 הפעלת מתזמן גיבוי מסודר בקבצים ותיקיות
    try:
        print("🗂️ מפעיל מתזמן גיבוי מסודר...")
        ...
        print(f"⚠️ שגיאה בהפעלת מתזמן גיבוי: {e}")
    ...
    print('✅ מתזמן גיבוי מסודר בקבצים ותיקיות פועל יומי ב-01:00')
